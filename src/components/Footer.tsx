            ...
            <div className="flex items-center gap-4">
              ...
              <div className="flex gap-3">
                <a
                  ...
                  className="w-8 h-8 bg-gradient-to-r from-purple-500 via-pink-500 to-orange-500 rounded-md flex items-center justify-center text-white hover:-translate-y-1 transition-transform duration-300"
                >
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-8 h-8 bg-black rounded-md flex items-center justify-center text-white hover:-translate-y-1 transition-transform duration-300"
                >
                  <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-8 h-8 bg-green-600 rounded-md flex items-center justify-center text-white hover:-translate-y-1 transition-transform duration-300"
                >
                  <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
